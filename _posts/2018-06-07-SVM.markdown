...
\\[ Max \quad \frac{2}{||W||} \quad { S.T. } y_i(W^Tx_i+b) \ge 1 \quad \forall \; i\\]
...
\\[( W^* , b^* ) = \text{ arg min } \quad \frac{||W||^2}{2} \quad { S.T }\quad y_i(W^Tx_i+b) \ge 1-\xi_i \quad \text{ For all i  and } \quad \xi_i > 0\\]
